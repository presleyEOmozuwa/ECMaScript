...
it("should generate jwt token, update its expiry time and returns status code 200 when user enables rememberMe and session id matches the one on the database", async () => {
