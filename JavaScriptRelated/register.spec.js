...
const { stripeCustomer } = require('../Register/register-helper');
...
jest.mock('../Register/register-helper');
...
describe("POST /api/register", () => {
    ...
    it.only("should return status code 200 when user is successfully registered", async () => {
    ...
    // it.only("should return status 200 when email confirmation link sent to user via an email server is successful", async () => {
